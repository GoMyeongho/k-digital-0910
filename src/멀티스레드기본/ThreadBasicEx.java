...
// 자바는 main() 메서드 호출 시 하나의 스레드가 생성된다.
// 멀티스레드가 수행중인 경우 main() 스레드가 종료 되더라도 어플리케이션은 종료되지 않는다.
// 스레드 생성 방법은
// 1. Thread 클래스를 상속 하는 방법 (상속 받으면, 다른 상속을 받을 수 없음)
// 2. Runnable 인터페이스를 상속받아 구현하는 방법
...
public class ThreadBasicEx {
    public static void main(String[] args) {
        ...
        Runnable runTask = new CustomRunnable();    // 작업 내용은 가지고 있지만 실제 스레드 동작은 없음
